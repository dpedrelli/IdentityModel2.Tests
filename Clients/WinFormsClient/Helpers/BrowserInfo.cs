...
namespace WinFormsClient.Helpers
{
    ...
    public class BrowserInfo : System.IComparable<BrowserInfo>
    {
        ...
        {
            if (StringHelpers.Contains(packageName, "Google")) return 1;
            if (StringHelpers.Contains(packageName, "Chromium")) return 2;
            if (StringHelpers.Contains(packageName, "Opera")) return 3;
            if (StringHelpers.Contains(packageName, "Firefox")) return 4;
            if (StringHelpers.Contains(packageName, "Midori")) return 5;
            if (StringHelpers.Contains(packageName, "Safari")) return 9000;
            if (StringHelpers.Contains(packageName, "Edge")) return 9998;
            if (StringHelpers.Contains(packageName, "Explorer")) return 9999;
    ...
    public class DistroInfo
    {
        ...
        public static Distro_t Distro
        {
            get
            {
                ...
                if (StringHelpers.Contains(issue, "Ubuntu"))
                ...
                if (StringHelpers.Contains(issue, "CentOS"))
